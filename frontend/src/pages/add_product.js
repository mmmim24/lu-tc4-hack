	...
	return (
		<Layout>
			<div className='grid relative grid-cols-4'>
				<div
					style={{ fontSize: "4em" }}
					className='my-16 flex items-center text-right col-span-1'
				>
					Add Product
				</div>
					...
					>
						<Form>
							<div className='mt-20 grid grid-cols-5 ml-16 gap-y-8'>
								<div className='row-start-1 col-span-1 text-lg'>
									Product Title
								</div>
								<Field
									name='title'
									className='px-4 py-2 row-start-1 col-span-2 border border-black rounded-lg'
								/>
								<div className='row-start-2 col-span-1 text-lg'>
									Product Description
								</div>
								<Field
									type='textarea'
									...
									className='px-4 py-2 row-start-2 col-span-2 border border-black rounded-lg'
								/>
								<div className='row-start-3 col-span-1 text-lg'>
									Minimum Bid
								</div>
								<Field
									type='number'
									name='minimum_bid'
									className='px-4 py-2 row-start-3 col-span-2 border border-black rounded-lg'
								/>
								<div className='row-start-4 col-span-1 text-lg'>Categories</div>
								<Field
									as='select'
									name='category'
									className='px-4 py-2 row-start-4 col-span-2 border border-black rounded-lg'
								>
									<option>Electronics</option>
									<option>Cosmetics</option>
									<option>Clothing</option>
								</Field>
								<div className='row-start-5 col-span-1 text-lg'>
									Product Images
								</div>
								...
								<Button
									className='center row-start-6 py-2 rounded'
									type='primary'
									htmlType='submit'
								>
									Submit
